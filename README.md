...
<table align="center">
    ...
    <tr>
        ...
        <td>
            ...
            <strong>TF:</strong> Esta entrega final fue un desafío significativo, especialmente con los cambios en el equipo. A pesar de las dificultades, traté de mantener una comunicación clara y efectiva con todos los miembros. Considero que hemos aprendido mucho sobre la importancia de la colaboración y la organización en un proyecto de esta magnitud, ya que son situaciones que viviremos en el mundo laboral.<br>
    ...
    <tr>
        ...
        <td>
            ...
            <strong>TF:</strong> En esta entrega traté de comunicar ideas de manera clara hacia mis compañeros para lograr la culminación del proeycto.Siento que pudimos haber realizado un mejor trabajo si no hubieramos tenido ciertas situaciones adversas que nos retrasaron. Siempre traté de brindar apoyo a mis compañeros para la elaboración de sus asignaciones.<br>
            <strong>Reyes Trujillano, Fabian Alonso</strong><br>
...
| US021 | RESTFul API de Productos | **Como** desarollador, **quiero** implementar un RESTful API **para** el registro en línea donde pueda ingresar la información básica de la tienda, como nombre, dirección y categoría de productos, para poder crear una cuenta en la plataforma | <p>**Escenario 1: Crear una nueva cuenta en la plataforma** </p><p></p><p>**Given** que el desarrollador tiene acceso al endpoint correspondiente para la creacion de cuenta  </p><p> **When** envia la solicitud POST </p><p>**Then** se crea una nueva cuenta con la información básica de la tienda, como nombre, dirección y categoría de productos. </p> |
...
| US023 | Landing Page | **Como** visitante, **quiero** quiero encontrar información clara y concisa sobre los servicios ofrecidos **para** entender rápidamente cómo pueden beneficiarme. | <p>**Escenario 1: Ingresar al Landing Page** </p><p></p><p>**Given** que el visitante llega a nuestra página web desplegada </p><p> **When** requiera hacer uso de nuestra plataforma y acceda al vínculo suscribirse a la aplicación </p><p>**Then** el botón lo dirige a nuestra aplicación que muestra la página de suscripción y crear cuenta para ingresar. </p> |
